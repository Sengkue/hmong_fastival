      ...
      <v-list density="compact" nav class="px-3 py-2 menu-list">
        ...
        <template v-if="authStore.isAdmin">
          <v-list-item
            ...
            title="Airports (Admin)"
            :to="localePath('/admin/airports')"
            rounded="lg"
            class="nav-item"
          ></v-list-item>
          ...
          <v-list-item
            ...
            title="SMS Logs & Stats"
            :to="localePath('/sms-stats')"
            rounded="lg"
            class="nav-item"
          ></v-list-item>
        </template>
